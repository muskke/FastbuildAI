...
export class Upgrade {
    ...
    async execute(): Promise<void> {
        this.logger.debug("开始执行 1.0.0-beta.6.1 版本升级逻辑");
        ...
        try {
            ...
            this.logger.debug("✅ 1.0.0-beta.6.1 版本升级逻辑执行完成");
        } catch (error) {
            this.logger.error(`❌ 1.0.0-beta.6.1 版本升级逻辑执行失败: ${error.message}`);
            throw error;
        }
    }
