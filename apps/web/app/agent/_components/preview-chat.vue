...
import type { UpdateAgentConfigParams } from "@/models/agent";
import type { AiMessage } from "@/models/ai-conversation";
import { apiAgentChat, apiCreateAgentAnnotation } from "@/services/web/agent";
                    ...
                    <template #content="{ message, index }">
                        ...
                        >
                            ...
                            <template #after>
                                ...
                                >
                                    <span class="text-muted-foreground flex-none text-xs">
                                        {{ message.metadata?.annotations?.createdBy }} 编辑的答案
                                    </span>
