...
import type { DatasetDocument, DatasetSegment, QuerySegmentParams } from "@/models/datasets";
import {
...
<template>
    <div class="flex h-full w-full flex-col">
        <div class="flex items-center justify-between gap-1 px-6 py-4">
            <div class="flex w-full items-center">
                <UButton
                    ...
                    @click="router.replace(`/datasets/${datasetId}/documents`)"
                />
        ...
        <div
            class="bg-background border-default mb-4 flex w-full justify-between gap-4 border-b px-6 py-4"
        >
