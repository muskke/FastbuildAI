...
import type { Dataset, QueryDatasetParams } from "@/services/web/datasets";
import { apiDeleteDataset, apiGetDatasetList, apiRetryDataset } from "@/services/web/datasets";
...
definePageMeta({
    layout: "default",
    name: "datasets.dataset.title",
    auth: false,
    inSystem: true,
    inLinkSelector: false,
});
</script>

<template>
    <div class="datasets-list-container flex flex-col items-center justify-center">
        <div class="datasets-list-container container px-4 py-6 lg:px-6">
            <!-- 搜索区域 -->
            ...
            <!-- 使用无限滚动 -->
            <ProScrollArea class="h-[calc(100vh-7rem)] min-h-0 w-full">
                <ProInfiniteScroll
                    :loading="loading"
                    :has-more="hasMore"
                    :threshold="200"
