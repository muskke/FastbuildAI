...
/** 国际化相关 */
import { getTranslationName, type LanguageCode, languageOptions } from "~/core/i18n/language";
...
const currentThemeMode = computed(() => {
    ...
    return store.value === "light"
        ? { label: t("console-common.theme.light"), icon: "i-lucide-sun" }
        : { label: t("console-common.theme.dark"), icon: "i-lucide-moon" };
});
    ...
    [
        {
            label:
                controlsStore.consoleLayoutMode === "side"
                    ? t("console-common.sidebar")
                    : t("console-common.mixture"),
            icon:
                controlsStore.consoleLayoutMode === "side"
                    ? "i-lucide-panel-left"
            ...
            children: [
                {
                    label: t("console-common.sidebar"),
                ...
                {
                    label: t("console-common.mixture"),
        ...
        {
            label: t("console-common.theme.theme"),
            icon: "i-lucide-palette",
            children: [
                {
                    label: t("console-common.theme.color"),
                    slot: "chip",
                ...
                {
                    label: t("console-common.theme.neutralLabel"),
                    slot: "chip",
