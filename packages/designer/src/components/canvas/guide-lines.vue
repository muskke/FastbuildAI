...
<template>
    <div class="pointer-events-none absolute top-0 left-0 z-5 h-full w-full">
        ...
        >
            <!-- 等间距标签（带特殊图标）-->
            <div
                class="pointer-events-none absolute flex items-center gap-1 rounded bg-green-500 px-1.5 py-0.5 text-[10px] font-medium whitespace-nowrap text-background shadow-sm"
                :style="
                    line.type === 'horizontal'
        ...
        >
            <!-- 间距标签 -->
            <div
                class="pointer-events-none absolute rounded bg-red-500 px-1.5 py-0.5 text-[10px] font-medium whitespace-nowrap text-background shadow-sm"
        ...
        >
            <!-- 画布距离标签 -->
            <div
                class="pointer-events-none absolute rounded bg-orange-500 px-1.5 py-0.5 text-[10px] font-medium whitespace-nowrap text-background shadow-sm"
                :style="
                    line.type === 'horizontal'
