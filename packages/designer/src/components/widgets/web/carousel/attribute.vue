 ...
 */
import { ProColorPicker, ProSlider, ProUploader } from "@fastbuildai/ui";
...
const tabItems = [
    { label: t("console-widgets.labels.imageManagement"), value: "images", slot: "images" },
    { label: t("console-widgets.labels.playbackSettings"), value: "playback", slot: "playback" },
];
...
const handleImageUpload = (index: number, files: File[]) => {
    if (files.length > 0) {
        ...
        reader.onload = (e) => {
            if (e.target?.result) {
                model.value.items[index].src = e.target.result as string;
            }
        };
            ...
            >
                ...
                <template #playback>
                    <div class="w-full space-y-3 px-1 pt-2 pb-4">
                        ...
                        >
                            <ProSlider v-model="model.slidesToScroll" :min="1" :max="5" size="md" />
                        </UFormField>
                ...
                <template #display>
                    <div class="w-full space-y-3 px-1 pt-2 pb-4">
                        ...
                        >
                            <ProSlider v-model="model.imageRadius" :min="0" :max="30" size="md" />
                        </UFormField>
