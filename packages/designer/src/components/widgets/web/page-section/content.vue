                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <div
                                    v-if="feature.to"
                                    class="from-primary to-secondary absolute inset-x-0 bottom-0 h-1 origin-left scale-x-0 transform bg-gradient-to-r transition-transform group-hover:scale-x-100"
                                />
                            </div>
                        </div>
                    </div>
