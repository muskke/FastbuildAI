...
import ProEditor from "@fastbuildai/ui/components/pro-editor.vue";
            ...
            >
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="min-h-[450px]">
                                    <ProEditor v-model="model.content" />
                                </div>
                            </ProModal>
                        </UFormField>
                    </div>
                ...
                <template #typography>
                    <div class="w-full space-y-3 px-1 pt-2 pb-4">
                        ...
                        >
                            <ProSlider v-model="model.fontSize" :min="10" :max="48" size="md" />
                        </UFormField>
                ...
                <template #layout>
                    <div class="w-full space-y-3 px-1 pt-2 pb-4">
                        ...
                        <UFormField
                            ...
                            :label="t('console-widgets.common.spacing')"
                        >
                            <ProSlider v-model="model.marginBottom" :min="0" :max="50" size="md" />
                        </UFormField>
                        ...
                        >
                            <ProSlider v-model="model.textIndent" :min="0" :max="100" size="md" />
                        </UFormField>
                    </div>
                </template>
                ...
                <template #advanced>
                    <div class="w-full space-y-3 px-1 pt-2 pb-4">
                        ...
                        >
                            <ProSlider v-model="model.maxLines" :min="0" :max="20" size="md" />
                        </UFormField>
