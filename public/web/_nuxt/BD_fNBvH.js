import{d as y,s as w,g as l,c as n,o as a,q as e,v as s,l as c,y as $,F as k,B as C,z as D,p as o,x as S,t as p}from"#entry";import{_ as T}from"./D5P4scfL.js";import"./DGIb7fSK.js";import"./Btvd554H.js";import"./3UOIlTK8.js";import"./DuSMYVIA.js";import"./DduSJdeS.js";import"./VGKgjfSv.js";import"./oFTPHjuc.js";import"./BcsO9TDZ.js";const j={class:"space-y-4"},z={class:"mb-2 text-lg font-medium"},B={class:"text-muted-foreground text-sm"},I={key:0,class:"border-border rounded-lg border p-6 text-center"},N={class:"mb-2 font-medium"},U={class:"text-muted-foreground text-sm"},V={key:1,class:"space-y-4"},A={class:"flex border-b"},E=["onClick"],J={class:"space-y-4"},K={key:0,class:"space-y-3"},P={class:"flex items-center justify-between"},q={class:"font-medium"},F={class:"relative"},L={class:"bg-muted overflow-auto rounded-lg p-4 text-sm"},R={class:"text-muted-foreground text-xs"},W={key:1,class:"space-y-3"},H={class:"flex items-center justify-between"},M={class:"relative"},G={class:"bg-muted overflow-auto rounded-lg p-4 text-sm"},O={class:"text-muted-foreground text-xs"},Q={key:2,class:"space-y-3"},X={class:"flex items-center justify-between"},Y={class:"font-medium"},Z={class:"relative"},ee={class:"bg-muted overflow-auto rounded-lg p-4 text-sm"},te={class:"text-muted-foreground text-xs"},se={class:"space-y-3"},oe={class:"font-medium"},ie={class:"border-border flex justify-center rounded-lg border p-6"},ne={class:"border-border overflow-hidden rounded-lg border shadow-lg",style:{width:"100%",height:"750px"}},ae=["src"],ve=y({__name:"embed-code",props:{agent:{}},setup(m){const h=m,d=w("iframe"),i=l(()=>h.agent?.publishToken?`${window.location.origin}/public/agent/shared/${h.agent.publishToken}`:""),b=l(()=>i.value?`<!-- BuildingAI 智能体嵌入代码 -->
<iframe
